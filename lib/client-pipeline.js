...
class PipelineBody extends EE {
  ...
  on (name, val) {
    if (name === 'data' && this._paused == null) {
      process.nextTick(() => this.resume())
    }
    return super.on(name, val)
  }
